...
def make_cip_button_visible_state(
    ...
    # Before/after grain-center RGB regression figure, produced by "calculate".
    # Shown only while CPO is selected and a figure exists (the figure being
    # non-None is enforced by make_elevated_button's not-None condition list).
    rgb_comparison = make_elevated_button(
        stores,
        "RGB comparison",
        stores.ui.selected_button_at_analysis_tab,
        selected_index,
