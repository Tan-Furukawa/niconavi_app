...
from niconavi_app.niconavi.image.type import RGBPicture, MonoColorPicture
...
from niconavi_app.niconavi.optics.optical_system import get_full_wave_plus_mineral_retardation_system
